...
public class ColorTemplate {
    ...
    public static final int[] LIBERTY_COLORS = {
            Color.rgb(237, 218, 246), Color.rgb(158, 212, 212), Color.rgb(136, 180, 187),
            Color.rgb(118, 174, 175), Color.rgb(42, 109, 130)
    };
    public static final int[] JOYFUL_COLORS = {
    	    Color.rgb(53, 194, 209),
            Color.rgb(17, 80, 138), Color.rgb(154, 149, 67), Color.rgb(254, 247, 120),
            Color.rgb(146, 167, 134)
    };
    public static final int[] PASTEL_COLORS = {
    	    Color.rgb(139, 48, 80),
            Color.rgb(164, 89, 128), Color.rgb(19, 165, 124), Color.rgb(217, 184, 162),
            Color.rgb(91, 134, 134) 
    };
    public static final int[] COLORFUL_COLORS = {
            Color.rgb(103, 37, 82), Color.rgb(225, 102, 0), Color.rgb(245, 199, 0),
            Color.rgb(106, 150, 31), Color.rgb(179, 100, 53)
    };
    public static final int[] VORDIPLOM_COLORS = {
            Color.rgb(162, 255, 140), Color.rgb(255, 242, 140), Color.rgb(255, 208, 140),
            Color.rgb(140, 24, 255), Color.rgb(215, 140, 157)
    };
