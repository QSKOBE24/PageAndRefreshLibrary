...
public class XAxis extends AxisBase {
     ...
     */
    private boolean mIsAxisModulusCustom = true;
     ...
     */
    private boolean mAvoidFirstLastClipping = true;

    /** the position of the x-labels relative to the chart
     * */
    private XAxisPosition mPosition = XAxisPosition.BOTH_SIDED;
     ...
     * ���һ���Զ����X��modulus�Ѿ���������������������ʱ��Ҫ���Եı�ǩ��Ŀ����ô����true;
     * @return
     */
