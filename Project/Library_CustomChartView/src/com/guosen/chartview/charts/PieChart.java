...
import com.guosen.chartview.render.PieChartRenderer;
...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    private boolean mUsePercentValues = true;
    
    /** if true, the slices of the piechart are rounded */
    private boolean mDrawRoundedSlices = true;
     ...
     * radius / 2
     */
    private float mHoleRadiusPercent = 58f;

    /**
     * the radius of the transparent circle next to the chart-hole in the center
     */
    private float mTransparentCircleRadiusPercent = 61f;
